...
public interface IGLRLogger {
  ...
  default void detectedParseTree(SentenceProcessingContext context,
  ...
  default void startGrammarProcessing(SentenceProcessingContext context,
      Grammar grammar) {
  }

  default void startSentenceProcessing(Sentence sentence,
  ...
  default void tokensModified(SentenceProcessingContext context,
      List<Token> tokens) {
