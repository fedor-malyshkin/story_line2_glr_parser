...
public class ParseTreeSerializerTest {
  ...
  public void checkSimpleSerialization_NoAgreements() throws Exception {
    ...
    ParseTreeNode userRoot = TestFixtureBuilder
        .createAndValidateParseTree(grammarText, tokens, grammarManager);
  ...
  @Test
  public void checkSerialization_WithCombinedGrammToken_WithNoRT()
      throws Exception {
    List<Token> tokens =
        tokenManager.splitIntoTokens("сильному синему участнику", true);
    String grammarText =
        "Root->S; S->Adj X; X->Adj<nc-agr=[1]> Noun<rt, nc-agr=[1]>;";
  ...
  public void checkSerialization_WithCombinedGrammToken() throws Exception {
    List<Token> tokens =
        tokenManager.splitIntoTokens("сильных синих участников", true);
    String grammarText =
  ...
  @Test
  public void checkSerialization_WithCombinedGrammToken_NoNormalization()
      throws Exception {
    List<Token> tokens =
        tokenManager.splitIntoTokens("сильных синих участников", true);
    String grammarText =
  ...
  public void checkSerialization_UnknownWords() throws Exception {
    List<Token> tokens =
        tokenManager.splitIntoTokens("сильных зурбабурба участников", true);
  ...
  public void checkCutRestriction_ForNonTerminal() throws Exception {
    List<Token> tokens =
        tokenManager.splitIntoTokens("синие сильные люди поехали", true);
