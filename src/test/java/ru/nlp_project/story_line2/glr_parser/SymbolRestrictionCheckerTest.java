...
public class SymbolRestrictionCheckerTest {
  ...
  public void setUp() throws Exception {
    testable = new SymbolRestrictionChecker(HierarchyManager.newInstance(null));
  }
  ...
  public void testMatchScore_NoAgreements2() {
    ...
    Grammemes grammemes1 = new Grammemes();
    GrammemeUtils.fillGrammemesByCSVMyTags("noun, nomn, masc, anim, plur",
        grammemes1, true);
    // {0=noun, 1=loct, 3=masc, 4=anim, 5=plur}
    Grammemes grammemes2 = new Grammemes();
    GrammemeUtils.fillGrammemesByCSVMyTags("noun, loct, masc, anim, plur",
        grammemes2, true);
    int matchScoreSame =
        SymbolRestrictionChecker.matchScore(grammemes1, grammemes1, null);
    int matchScoreOther =
        SymbolRestrictionChecker.matchScore(grammemes1, grammemes2, null);
    assertTrue("matchScoreSame > matchScoreOther",
        matchScoreSame > matchScoreOther);
  }
  ...
  public void testMatchScore_GN_Agreements() {
    ...
    GrammemeUtils.fillGrammemesByCSVMyTags("noun, loct, masc, anim, plur",
        grammemes2, true);
    int matchScore_Same_GN = SymbolRestrictionChecker.matchScore(grammemes1,
        grammemes1, SymbolExtDataTypes.gn_agr);
    int matchScore_Other_GN = SymbolRestrictionChecker.matchScore(grammemes1,
  ...
  public void testMatchGramm_NoMatch() {
    ...
    assertFalse(
        testable.matchGram(symbolExtData2.getGrammValue(), symbolExt, token));
  }
   ...
   * Результат:
   * - someVal (noun, accs)
   * + someVal (noun, accs, plur)
   * - someVal (noun, accs, sing)
   * 
   */
  @Test
  public void testMatchGrammEx() {
    ...
    SymbolExtData symbolExtData1 = SymbolExtData.makeLabelExtData("rt");
    SymbolExtData symbolExtData2 =
        SymbolExtData.makeParamExtData("gram-ex", "geox");
    SymbolExtData symbolExtData3 = SymbolExtData.makeLabelExtData("h-reg1");
    List<SymbolExtData> symbolExtDatas =
        Arrays.asList(symbolExtData1, symbolExtData2, symbolExtData3);
    SymbolExt symbolExt =
        new SymbolExt("word", SymbolTypes.Terminal, symbolExtDatas);
    ...
    assertTrue(
        testable.matchGramEx(symbolExtData2.getGrammValue(), symbolExt, token));
  }
  ...
  public void testMatchKWType() throws IOException {
    ...
    // symbol ext
    SymbolExtData symbolExtData2 =
        SymbolExtData.makeParamExtData("kwtype", "kwName_toMatch");
  ...
  public void testMatchGU() {
    // symbol ext
    SymbolExtData symbolExtData2 =
        SymbolExtData.makeArrayExtData("GU", "sing, accs");
    List<SymbolExtData> symbolExtDatas = Arrays.asList(symbolExtData2);
    SymbolExt symbolExt =
        new SymbolExt("val", SymbolTypes.Terminal, symbolExtDatas);
    ...
    assertFalse(
        testable.matchGU(symbolExtData2.getGuValue(), symbolExt, token));
  ...
  public void testMatchGU_WithAmpersand() {
    // symbol ext
    SymbolExtData symbolExtData2 =
        SymbolExtData.makeArrayExtData("GU", "&(sing, accs, nomn)");
    List<SymbolExtData> symbolExtDatas = Arrays.asList(symbolExtData2);
    SymbolExt symbolExt =
        new SymbolExt("val", SymbolTypes.Terminal, symbolExtDatas);
  ...
  */
  ...
  public void testRxM() {
    // symbol ext
    SymbolExtData symbolExtData2 =
        SymbolExtData.makeParamExtData("rx", "им\\..*");
    List<SymbolExtData> symbolExtDatas = Arrays.asList(symbolExtData2);
    SymbolExt symbolExt =
        new SymbolExt("val", SymbolTypes.Terminal, symbolExtDatas);
